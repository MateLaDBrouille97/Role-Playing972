...
with st.sidebar:
#   st.markdown(f"""    
#     1) Enter the Assistant Role Name!
#     2) Enter the User Role Name! 
#     3) Enter OpenAI API key. This costs $. Set up billing at [OpenAI](https://platform.openai.com/account).
#     4) Type a question and Press 'Start Sequence'.🎈 """)
...
st.title('APP using 🦜️🔗 :red[Role-Playing]') #Shows the title in the web app
st.header(' _Autonomous_ Cooperative :blue[Agents]') #Shows the header in the web app... blue and italics
